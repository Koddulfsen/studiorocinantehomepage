...
export const packages: Package[] = [
  {
    ...
    includes: [
      "Verified, fully optimized Google Business Profile",
      "Best-fit categories, so you show up for the right searches",
      "Complete profile — hours, photos, menu, attributes, all filled in",
      "Consistent listing across Google, Yelp, TripAdvisor & more",
      "Regular posts and new photos, keeping your listing active",
      "We respond to every review, good or bad",
      "Ongoing protection against fake reviews, suspensions & rogue edits",
      "Monthly report",
    ],
  },
  {
    ...
    includes: [
      ...
      "Fast-loading, mobile-first, built to pass Google's speed benchmarks",
      "Real menu page & structured data Google can actually read",
      "Click-to-call, smart navigation, reservation-ready",
      "SEO best practices for content and pages",
      "Domain, hosting & uptime monitoring included",
  ...
  },
  {
    ...
    includes: [
      ...
      "Same business info everywhere (NAP) — boosts your Google ranking",
